from sri.parser.medline import get_data, get_txt_data,\
                                get_qry_data, get_med_rel, get_med_rel_numpy
import json
...
med_rel = get_med_rel(PATH_TO_MED_REL)
med_rel_numpy = get_med_rel_numpy(PATH_TO_MED_REL)
print(med_rel)
print(med_rel_numpy)
